...
<table class=" min-w-full text-sm text-left float-right">
    <thead>
        ...
        <td class="py-2 px-4 text-gray-700">₱84,000</td>
    ...
    <tr class="border-b">
        ...
        <td class="py-2 px-4 text-gray-700">₱37,500</td>
        <td class="py-2 px-4 text-red-500">-₱7,500</td>
    </tr>
    <tr class="border-b">
        <td class="py-2 px-4 text-gray-700">Salaries</td>
        <td class="py-2 px-4 text-gray-700">₱300,000</td>
        <td class="py-2 px-4 text-gray-700">₱294,000</td>
        <td class="py-2 px-4 text-green-500">₱6,000</td>
    </tr>
    <tr class="border-b">
        <td class="py-2 px-4 text-gray-700">Bonuses</td>
        <td class="py-2 px-4 text-gray-700">₱60,000</td>
        <td class="py-2 px-4 text-gray-700">₱54,000</td>
        <td class="py-2 px-4 text-green-500">₱6,000</td>
    </tr>
    <tr class="border-b">
        <td class="py-2 px-4 text-gray-700">Facility Cost</td>
        <td class="py-2 px-4 text-gray-700">₱45,000</td>
        <td class="py-2 px-4 text-gray-700">₱45,000</td>
        <td class="py-2 px-4 text-gray-500">₱0</td>
    </tr>
    <tr class="border-b">
        <td class="py-2 px-4 text-gray-700">Training</td>
        <td class="py-2 px-4 text-gray-700">₱24,000</td>
        <td class="py-2 px-4 text-gray-700">₱22,500</td>
        <td class="py-2 px-4 text-green-500">₱1,500</td>
    </tr>
    <tr class="border-b">
        <td class="py-2 px-4 text-gray-700">Wellness</td>
        <td class="py-2 px-4 text-gray-700">₱9,000</td>
        <td class="py-2 px-4 text-gray-700">₱10,500</td>
        <td class="py-2 px-4 text-red-500">-₱1,500</td>
    </tr>
    <tr class="border-b">
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            ...
            <span class="text-gray-700">₱7,500</span> <!-- Remaining Budget -->
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2 mb-2">
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            ...
            <span class="text-gray-700">₱1,500</span> <!-- Remaining Budget -->
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2 mb-2">
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            ...
            <span class="text-gray-700">₱90,000</span> <!-- Budgeted amount -->
        </div>
        <div class="text-sm text-gray-600">
            <span>Variance: </span>
            <span class="text-green-500">+₱6,000</span> <!-- Predicted increase based on variance -->
        </div>
    </div>
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            ...
            <span class="text-red-600">₱37,500</span> <!-- Budgeted amount -->
        </div>
        <div class="text-sm text-gray-600">
            <span>Variance: </span>
            <span class="text-red-500">-₱7,500</span> <!-- Predicted increase due to variance -->
        </div>
    </div>
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            <span class="text-gray-700">Salaries</span>
            <span class="text-gray-700">₱300,000</span> <!-- Budgeted amount -->
        </div>
        <div class="text-sm text-gray-600">
            <span>Variance: </span>
            <span class="text-green-500">+₱6,000</span> <!-- Predicted savings based on variance -->
        </div>
    </div>
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            <span class="text-gray-700">Bonuses</span>
            <span class="text-gray-700">₱60,000</span> <!-- Budgeted amount -->
        </div>
        <div class="text-sm text-gray-600">
            <span>Variance: </span>
            <span class="text-green-500">+₱6,000</span> <!-- Predicted savings based on variance -->
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            <span class="text-gray-700">Facility Cost</span>
            <span class="text-gray-700">₱45,000</span> <!-- Budgeted amount -->
        </div>
        <div class="text-sm text-gray-600">
            <span>Variance: </span>
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            ...
            <span class="text-gray-700">₱24,000</span> <!-- Budgeted amount -->
        </div>
        <div class="text-sm text-gray-600">
            <span>Variance: </span>
            <span class="text-green-500">+₱1,500</span> <!-- Slight increase forecasted -->
        </div>
    </div>
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            ...
            <span class="text-red-600">₱10,500</span> <!-- Budgeted amount -->
        </div>
        <div class="text-sm text-gray-600">
            <span>Variance: </span>
            <span class="text-red-500">-₱1,500</span> <!-- Forecasted increase based on variance -->
        </div>
    </div>
    ...
    <div class="mb-4">
        <div class="flex justify-between mb-2">
            <span class="text-gray-700">Tax Payment</span>
            <span class="text-gray-700">₱36,000</span> <!-- Budgeted amount -->
        </div>
        <div class="text-sm text-gray-600">
            <span>Variance: </span>
            <span class="text-gray-600">₱0</span> <!-- No change forecasted -->
